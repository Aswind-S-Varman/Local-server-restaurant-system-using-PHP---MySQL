...
<div class="w3-top w3-hide-small">
  <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
    ...
    <?php $get_param = "?id=" . $_SESSION["ID"] . "&level=" . $rows['level']; ?>
    <a href="reservation_form.php" class="w3-bar-item w3-button">RESERVATION</a>
    <a href="logout.php"><button  class="login" class="w3-bar-item w3-button">LOG OUT</a></button>
...
<div class="w3-container w3-padding-64 w3-red w3-xlarge" id="about">
  <div class="w3-content">
    ...
    <img src="interior.jpg" style="width:100%" class="w3-margin-top w3-margin-bottom" alt="Restaurant">
...
<div class="w3-container w3-padding-64 w3-blue-grey w3-grayscale-min w3-xlarge" id="myMap">
  <div class="w3-content">
    ...
    <input type="hidden" name="user_id" value="<?php echo $_SESSION['LEVEL'] == 3? $customer_data['userid']: "admin"; ?>">
      <p><input class="w3-input w3-padding-16 w3-border" type = "text" name = "Name" value ="<?php echo $_SESSION['LEVEL'] == 3? $customer_data['name']: "admin"; ?>" readonly></p>
      <p><input class="w3-input w3-padding-16 w3-border" type = "text" name = "Email" value ="<?php echo $_SESSION['LEVEL'] == 3? $customer_data['email']: "admin"; ?>" readonly></p>
